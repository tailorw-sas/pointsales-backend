...
import com.kynsof.shift.application.command.block.create.CreateBlockCommand;
import com.kynsof.shift.application.command.block.create.CreateBlockMessage;
import com.kynsof.shift.application.command.block.create.CreateBlockRequest;
import com.kynsof.shift.application.command.block.delete.DeleteBlockCommand;
import com.kynsof.shift.application.command.block.delete.DeleteBlockMessage;
import com.kynsof.shift.application.command.block.update.UpdateBlockCommand;
import com.kynsof.shift.application.command.block.update.UpdateBlockMessage;
import com.kynsof.shift.application.command.block.update.UpdateBlockRequest;
import com.kynsof.shift.application.query.BlockResponse;
import com.kynsof.shift.application.query.block.getbyid.FindBlockByIdQuery;
import com.kynsof.shift.application.query.block.search.GetSearchBlockQuery;
